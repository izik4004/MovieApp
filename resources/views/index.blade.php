        ...
        <div class="popular-movies">
            ...
            <div class="grid gap-8 gap-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-2">
                        <a href="#" class="mt-2 text-lg hover:text-gray:300">{{ $popularMovie['title'] }}</a>
                        <div class="flex items-center mt-1 text-sm text-gray-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 text-orange-500 text-yellow-500 fill-current" viewBox="0 0 24 24">
