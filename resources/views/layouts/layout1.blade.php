...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-white bg-black" >
        <section class="bg-right bg-cover bg-opacity-5">
    ...
    <div class="bg-black border-t-2 border-gray-900">
        <div class="px-4 pt-16 mx-auto lg:max-w-screen-2xl md:px-24 lg:px-6">
          <div class="grid row-gap-10 mb-8 lg:grid-cols-6">
            <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
              <div>
                <a href="" class="pl-0 text-5xl font-bold text-redish">FUNBOX</a>
              </div>
              <div>
                <p class="font-medium tracking-wide text-gray-300">FAQ</p>
                <ul class="mt-2 space-y-2">
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">About</a>
                  </li>
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Contact</a>
                  </li>
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Privacy Policy</a>
                  </li>
                  
                </ul>
              </div>
              <div>
                <p class="font-medium tracking-wide text-gray-300">Account</p>
                <ul class="mt-2 space-y-2">
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Terms</a>
                  </li>
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Help Centre</a>
                  </li>
                  <li>
                    <a href="/" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">How to</a>
                  </li>
            ...
            <div class="md:max-w-md lg:col-span-2">
              ...
              <form class="flex flex-col mt-4 md:flex-row">
                ...
                <button
                  type="submit"
                  class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-redish hover:bg-red-700 focus:shadow-outline focus:outline-none"
                >
                  Subscribe
                </button>
              </form>
